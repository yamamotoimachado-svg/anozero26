"use strict";
var node_worker_threads = require("node:worker_threads"), isPlainObject = require("lodash-es/isPlainObject.js"), oneline = require("oneline"), getStudioWorkspaces = require("../../../_chunks-cjs/getStudioWorkspaces.cjs");
