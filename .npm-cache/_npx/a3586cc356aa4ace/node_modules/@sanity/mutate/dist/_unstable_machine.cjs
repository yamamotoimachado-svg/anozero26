...
var createOptimisticStore = require("./_chunks-cjs/createOptimisticStore.cjs"), mendoza = require("mendoza"), rxjs = require("rxjs"), xstate = require("xstate"), encode = require("./_chunks-cjs/encode.cjs");
...
exports.applyMutations = createOptimisticStore.applyMutations;
exports.commit = createOptimisticStore.commit;
exports.rebase = createOptimisticStore.rebase;
exports.squashDMPStrings = createOptimisticStore.squashDMPStrings;
exports.squashMutationGroups = createOptimisticStore.squashMutationGroups;
