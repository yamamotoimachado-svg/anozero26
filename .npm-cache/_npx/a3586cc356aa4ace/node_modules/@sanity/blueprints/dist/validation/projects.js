 ...
 */
export function validateProject(resource) {
    if (!resource)
        return [{ type: 'invalid_value', message: 'Project config must be provided' }];
    if (typeof resource !== 'object')
        return [{ type: 'invalid_type', message: 'Project config must be an object' }];
    const errors = validateResource(resource, { projectContained: false });
