...
function findCrossCdr(doc, set) {
    return extractWithPath('..[_ref]', doc).map((match)=>get(doc, match.path.slice(0, -1))).filter((ref)=>typeof ref?._dataset === 'string').reduce((datasets, ref)=>datasets.add(ref._dataset), set);
}
