  ...
  ${transaction && !progress.done
    ...
    async promptConfirmMigrate(apiConfig) {
        const response = await confirm({
            message: `This migration will run on the ${styleText(['yellow', 'bold'], apiConfig.dataset)} dataset in ${styleText(['yellow', 'bold'], apiConfig.projectId)} project. Are you sure?`,
        });
        if (!response) {
